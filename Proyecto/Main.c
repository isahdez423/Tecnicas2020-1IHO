...
int menu2()
{
    ...
    printf("4. Modificar campos de un local \n");
    ...
    printf("8. Ordenar por valor de ventas(Piso)\n");
    printf("9. Ordenar por numero de trabajadores(Piso)\n");
    printf("10. Ordenar por valor de alquiler(CC)\n");
    printf("11. Ordenar locales por mayor consumo(CC)\n");
    printf("12. Salir\n");
    scanf("%d", &option);
    return option;
}
...
int menuVisitante(){
    int option;
    printf(" Opciones  \n\n");
    printf("1. Calificar Centro Comercial \n");
        ...
        if (option==1){
            ...
            switch (option2)
            {
                ...
                case 7:
                    ...
                    break;
                case 8:
                    ordenarVentas(centroComercial,numPisos, numLocalesxPiso);
	                break;
                case 9:
                    ordenarNumeroTrabajadores(centroComercial,numPisos, numLocalesxPiso);
                    break;
                case 10:
                    ordenarValorAlquiler(centroComercial,numPisos, numLocalesxPiso);
                    break;
                case 11:
                    ordenarLocalesConsumo(centroComercial,numPisos, numLocalesxPiso);
                    break;
            }
        }else if (option==2){
            option3=menuVisitante();
            switch (option3)
            {
            case 1:
            ...
            case 2:
                buscarLocalNombre(centroComercial,numPisos, numLocalesxPiso);
                break;
            }
